 ...
 * 4. use publishabl key and use stripe to get information and error
 * 
 * #v6:
 * 5.create payment intent post on the server and return client secret.
 * install stripe on the server side and get client secret.make sure you used the payment
 *  method types: ['card']
